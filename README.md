...
![A solution to the SIR model system](/examples/img/sir_sol.pdf?raw=true "SIR Solution")
...
![A solution to the SEIR model system](/examples/img/seir_sol.pdf?raw=true "SEIR Solution")
...
![A solution to the SEIRS model system](/examples/img/seirs_sol.pdf?raw=true "SEIRS Solution")
